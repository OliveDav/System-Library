...
public class ConsultarProveedores extends javax.swing.JFrame {
    ...
    public void pintarTabla(){
        ...
        DefaultTableModel t = new DefaultTableModel(encabezado, ProyectProg1.proveedores.size());
        jTable1.setModel(t);
        TableModel tabla = jTable1.getModel();
        
        for(int i= 0; i<ProyectProg1.proveedores.size();i++){
            Proveedores p = ProyectProg1.proveedores.get(i);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(eliminar > -1){
            ...
            ProyectProg1.proveedores.remove(eliminar);
            pintarTabla();
            }
        }else{
            JOptionPane.showMessageDialog(this, "Selecciones un proveedor valido para eliminar");
        }
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(jTable1.getSelectedRow()>=0){
            p = ProyectProg1.proveedores.get(jTable1.getSelectedRow());
            jTextField1.setText(p.Nit);
            jTextField2.setText(p.Direccion);
            jTextField3.setText(p.Telefono);
            jTextField4.setText(p.Nombre);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (p != null) {
            ...
            pintarTabla();
            JOptionPane.showMessageDialog(this, "Proveedor modificados exitosamente");
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
